...
import { LayoutDashboard, FileText, UploadCloud, Users, Settings, LogOut, Menu, X, WifiOff, Wifi, HardDrive, ExternalLink } from 'lucide-react';
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 gap-6 relative">
        ...
        <aside className="hidden lg:block w-64 shrink-0">
          <nav className="space-y-1">
            ...
            <Link
              to="/"
              className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold text-sky-600 hover:bg-sky-50 hover:text-sky-800 transition"
            >
